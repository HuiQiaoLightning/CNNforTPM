...
class DiffractionLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        super(DiffractionLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class RefractionLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        self.kernel = self.add_weight(name='Refraction_weight',
                                        ...
                                        trainable=True)
        super(RefractionLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class FrequencyShiftLayer(Layer):
    ...
    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(FrequencyShiftLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class LowPassLayer(Layer):
    ...
    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(LowPassLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class ImagLogLayer(Layer):
    ...
    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(ImagLogLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class AddLayer(Layer):
    ...
    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(AddLayer, self).build(input_shape)  # Be sure to call this somewhere!
...
class MinusMinLayer(Layer):
    def __init__(self, M, N, mask, **kwargs):
        self.M = M
        self.N = N
        self.mask = mask
        super(MinusMinLayer, self).__init__(**kwargs)

    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(MinusMinLayer, self).build(input_shape)  # Be sure to call this somewhere!

    def call(self, x):
        return self.mask * (x - K.min(x * self.mask))
...
class PropWindowLayer(Layer):
    ...
    def build(self, input_shape):
        # Create a trainable weight variable for this layer.
        super(PropWindowLayer, self).build(input_shape)  # Be sure to call this somewhere!
